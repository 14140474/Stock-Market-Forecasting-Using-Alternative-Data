...
def get_multi_keyword_weekday_trends(keywords_list, start_year, start_mon, start_day, end_year, end_mon, end_day, geo='GB'):
    """
...
if __name__ == '__main__':
    ...
    keywords_to_search = [
        'astrazeneca', 'AZN', 'astrazeneca stock', 'shell', 'shel', 
        'shell stock', 'debt', 'stocks', 'portfolio', 'inflation', 'risk', 
    ...
    if not all_keywords_data.empty:
        ...
        print("\nLast 5 Rows of Combined Rescaled Dat")
        print(all_keywords_data.tail())

        try:
            csv_filename = "google_trends_multiple_keywords_UK_weekdays_rescaled.csv"
