...
def get_multi_keyword_weekday_trends(keywords_list, start_year, start_mon, start_day, end_year, end_mon, end_day, geo='SG'):
    """
...
if __name__ == '__main__':
    ...
    keywords_to_search = [
        'DBS Group', 'D05', 'DBS stock', 'Singapore Telecommunications', 'Z74', 
        'Singtel stock', 'debt', 'stocks', 'portfolio', 'inflation', 'risk', 
    ...
    if not all_keywords_data.empty:
        ...
        try:
            csv_filename = "google_trends_multiple_keywords_SG_weekdays_rescaled.csv"
