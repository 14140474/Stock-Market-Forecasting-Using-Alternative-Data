...
print("--- 2. Loading and Combining Data from Excel Sheets ---")
all_data_list = []
try:
...
for company_name, (sheet_name, ticker) in sheet_names_map.items():
    ...
    for model_name, features in models_to_run.items():
        ...
        model = KNeighborsClassifier(
            n_neighbors=15, # A common starting point for K
...
if all_model_results:
    ...
    final_filename = 'final_summary_and_stats_knn_log.csv'
