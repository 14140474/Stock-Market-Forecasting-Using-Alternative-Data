...
#  Log Transformation to specified variables to reduce skewness 
...
# create lagged features for variables not available before market open
...
for company_name, (sheet_name, ticker) in sheet_names_map.items():
    ...
    for model_name, features in models_to_run.items():
        ...
        # --- NEW: Standardize the data for SVC ---
...
if all_model_results:
    ...
    final_filename = 'final_summary_and_stats_svc_log2.csv'
